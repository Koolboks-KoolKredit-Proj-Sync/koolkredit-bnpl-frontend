...
export default function CustomerOtpVerification() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://web-production-88f7c.up.railway.app/api/agent-followup/verify-otp", {
        method: "POST",
          ...
          `,
            ...
            if (result.isConfirmed) {
              try {
                ...
                const guarantorResponse = await fetch("https://web-production-88f7c.up.railway.app/api/guarantor/request", {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  // body: JSON.stringify({
